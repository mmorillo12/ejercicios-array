    ...
    class Alturas{
        ...
        public void comparar(){
            for(int i = 0; i < altura.Length;i++){
                if(i > promedio){
                    Console.WriteLine("La persona con {0} es mas grande que el promedio", altura[i]);
                }
                else if(i == promedio){
                    Console.WriteLine("La persona con {0} tiene una altura promedio", altura[i]);
                }
                else{
                    Console.WriteLine("La persona con {0} es mas pequeña que es promedio", altura[i]);
                }
            }
        }
    }
